...
class ProposedBundleTestCase(TestCase):
  ...
  def test_add_transaction_long_message(self):
    ...
    print_var_type_n_val(var001 = tag, pointer = '#SD3456JHG')#SD3456JHG
# Value: RBWAQBWA9999999999999999999
# Type: <class 'iota.types.Tag'>
    self.bundle.add_transaction(ProposedTransaction(
      address = address,
      tag     = tag,
...
"Forty-two," said Deep Thought, with infinite majesty and calm.
    ...
    m001 = """
    this is going to be a very long text
    """
    print_var_type_n_val(var001 = m001, pointer = "#qmslfkqsmll")#qmslfkqsmll_
