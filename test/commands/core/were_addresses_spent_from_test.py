...
# # Looks like I_ve delete the line above
...
class WereAddressesSpentFromRequestFilterTestCase(BaseFilterTestCase):
  ...
  print_var_type_n_val(var001 = filter_type, pointer = "#QSDFGHbvcvff23456")#QSDFGHbvcvff23456_
  ...
  def test_pass_happy_path(self):
    ...
    print_var_type_n_val(var001 = filter_, pointer = "#SDFGHytre123459999")#SDFGHytre123459999_
  ...
  def test_pass_compatible_types(self):
    ...
    filter_ = self._filter(request)
    print_var_type_n_val(var001 = filter_, pointer = "#sdfgGFDSSDFGgfdZZZ333")#sdfgGFDSSDFGgfdZZZ333_
