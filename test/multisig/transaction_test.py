...
class ProposedMultisigBundleTestCase(TestCase):
  ...
  def setUp(self):
    ...
    print_var_type_n_val(var001 = self.bundle, pointer = "#234fcvredfrZER")#234fcvredfrZER
# Value: 
...
# Type: iota.multisig.transaction.ProposedMultisigBundle
    ...
    print_var_type_n_val(var001 = self.trytes_1, pointer = "#Z456gXCVBjtrTY844")#Z456gXCVBjtrTY844
