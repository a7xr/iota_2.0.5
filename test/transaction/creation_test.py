...
class ProposedBundleTestCase(TestCase):
  def setUp(self):
    ...
    self.seed = Seed(b'TESTVALUE9DONTUSEINPRODUCTION99999RLC9CS'b'ZUILGDTLJMRCJSDVEEJO9A9LHAEHMNAMVXRMOXTBN')
    # print("type() 001 : ", type(self.seed))
    # # <class 'iota.crypto.types.Seed'>
    # print("self.seed 001: ", self.seed)
    # # TESTVALUE9DONTUSEINPRODUCTION99999RLC9CSZUILGDTLJMRCJSDVEEJO9A9LHAEHMNAMVXRMOXTBN
    ...
    # noinspection SpellCheckingInspection
    self.input_0_bal_eq_42 = Address(balance         = 42, key_index       = 0, security_level  = 1, trytes = b'JBLDCCSI9VKU9ZHNZCUTC9NLQIIJX9SIKUJNKNKE'b'9KKMHXFMIXHLKQQAVTTNPRCZENGLIPALHKLNKTXCU', )
    # print("type() 002 : ", type(self.input_0_bal_eq_42))
    # # <class 'iota.types.Address'>
    # print("self.input_0_bal_eq_42 002: ", self.input_0_bal_eq_42)
    # # JBLDCCSI9VKU9ZHNZCUTC9NLQIIJX9SIKUJNKNKE9KKMHXFMIXHLKQQAVTTNPRCZENGLIPALHKLNKTXCU

    # noinspection SpellCheckingInspection
    self.input_1_bal_eq_40 = Address(balance         = 40, key_index       = 1, security_level  = 1, trytes = b'KHWHSTISMVVSDCOMHVFIFCTINWZT9EHJUATYSMCX'b'DSMZXPL9KXREBBYHJGRBCYVGPJQEHEDPXLBDJNQNX', )
    # print("type() 003 : ", type(self.input_1_bal_eq_40))
    # # <class 'iota.types.Address'>
    # print("self.input_1_bal_eq_40 003: ", self.input_1_bal_eq_40)
    # # KHWHSTISMVVSDCOMHVFIFCTINWZT9EHJUATYSMCXDSMZXPL9KXREBBYHJGRBCYVGPJQEHEDPXLBDJNQNX

    # noinspection SpellCheckingInspection
    self.input_2_bal_eq_2 = Address(balance         = 2, key_index       = 2, security_level  = 1, trytes = b'GOAAMRU9EALPO9GKBOWUVZVQEJMB9CSGIZJATHRB'b'TRRJPNTSQRZTASRBTQCRFAIDOGTWSHIDGOUUULQIG', )
    # print("type() 004 : ", type(self.input_2_bal_eq_2))
    # # otrn le teo aloo
    # print("self.input_2_bal_eq_2 004: ", self.input_2_bal_eq_2)
    # # otrn le teo aloo

    # noinspection SpellCheckingInspection
    self.input_3_bal_eq_100 = Address(balance         = 100, key_index       = 3, security_level  = 1, trytes = b'9LPQCSJGYUJMLWKMLJ9KYUYJ9RMDBZZWPHXMGKRG'b'YLOAZNKJR9VDYSONVAJRIPVWCOZKFMEKUSWHPSDDZ', )
    # print("type() 005 : ", type(self.input_3_bal_eq_100))
    # # otrn le teo aloo
    # print("self.input_3_bal_eq_100 005: ", self.input_3_bal_eq_100)
    # # otrn le teo aloo

    # noinspection SpellCheckingInspection
    self.input_4_bal_eq_42_sl_2 = Address(balance         = 42, key_index       = 4, security_level  = 2, trytes = b'NVGLHFZWLEQAWBDJXCWJBMVBVNXEG9DALNBTAYMK'b'EMMJ9BCDVVHJJLSTQW9JEJXUUX9JNFGALBNASRDUD', )
    # print("type() 006 : ", type(self.input_4_bal_eq_42_sl_2))
    # # otrn le teo aloo
    # print("self.input_4_bal_eq_42_sl_2 006: ", self.input_4_bal_eq_42_sl_2)
    # # otrn le teo aloo

    # noinspection SpellCheckingInspection
    self.input_5_bal_eq_42_sl_3 = Address(balance         = 42, key_index       = 5, security_level  = 3, trytes = b'XXYRPQ9BDZGKZZQLYNSBDD9HZLI9OFRK9TZCTU9P'b'FAJYXZIZGO9BWLOCNGVMTLFQFMGJWYRMLXSCW9UTQ', )
    # print("type() 007 : ", type(self.input_5_bal_eq_42_sl_3))
    # # otrn le teo aloo
    # print("self.input_5_bal_eq_42_sl_3 007: ", self.input_5_bal_eq_42_sl_3)
    # # otrn le teo aloo

    # this is initialised here, and this is going to be added on the go
    self.bundle = ProposedBundle()
    # print("type() 008 : ", type(self.bundle))
    # # iota.transaction.creation.ProposedBundle
    # print("self.bundle 008: ", self.bundle)
    # # <iota.transaction.creation.ProposedBundle object at 0x0000024FD184CFD0>
  ...
  def test_add_transaction_long_message(self):
    ...
    """
    # noinspection SpellCheckingInspection
    address = Address(b'TESTVALUE9DONTUSEINPRODUCTION99999N9GIUF'b'HCFIUGLBSCKELC9IYENFPHCEWHIDCHCGGEH9OFZBN')
    # check above for its same kind

    tag = Tag.from_unicode('H2G2')
    # print('type(tag) 001: ', type(tag))
...
"Forty-two," said Deep Thought, with infinite majesty and calm.
    ...
    # print('self.bundle 002: ', self.bundle)
    # # <iota.transaction.creation.ProposedBundle object at 0x00000195E66C0518>
  ...
  def test_add_transaction_error_already_finalized(self):
    ...
    # print("len(self.bundle): ", len(self.bundle))
    # # 1
    # # # if you are going to add another transaction with self.bundle.add_transaction(...), then this is going to be incremented
  ...
  def test_add_transaction_error_negative_value(self):
    ...
    with self.assertRaises(ValueError):
      # # once again: type(self.bundle)=iota.transaction.creation.ProposedBundle
      self.bundle.add_transaction(ProposedTransaction(
        address = Address(b''),
        value   = -1,
      ))
  ...
  def test_add_inputs_with_change(self):
    ...
    # noinspection SpellCheckingInspection
    change_address = Address(b'TESTVALUE9DONTUSEINPRODUCTION99999KAFGVC'b'IBLHS9JBZCEFDELEGFDCZGIEGCPFEIQEYGA9UFPAE')
  ...
  def test_finalize_insecure_bundle(self):
    ...
    """
    # noinspection SpellCheckingInspection
    bundle = ProposedBundle([ProposedTransaction(address = Address('9XV9RJGFJJZWITDPKSQXRTHCKJAIZZY9BYLBEQUX''UNCLITRQDR9CCD99AANMXYEKD9GLJGVB9HIAGRIBQ', ), tag       = Tag('PPDIDNQDJZGUQKOWJ9JZRCKOVGP'), timestamp = 1509136296, value     = 0, ), ])
    bundle.finalize()
  ...
  def test_sign_input_at_single_fragment(self):
    ...
    private_key = KeyGenerator(self.seed).get_key_for(self.input_0_bal_eq_42)
  ...
  def test_sign_input_at_multiple_fragments(self):
    ...
    private_key = KeyGenerator(self.seed).get_key_for(self.input_5_bal_eq_42_sl_3)
