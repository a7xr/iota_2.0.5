...
class SandboxAdapterTestCase(TestCase):
  ...
  #   # print_var_type_n_val(var001 = adapter, pointer = "#2345HGFDXCnbvZEYT124")#2345HGFDXCnbvZEYT124_
  ...
  #   print("type(mocked_response)2: ", mocked_response)
  #   print("mocked_response2: ", mocked_response)
  #   mocked_sender = mock.Mock(return_value=mocked_response)
  #   print("type(mocked_sender)3: ", mocked_sender)
  #   print("mocked_sender3: ", mocked_sender)
  ...
  def test_sandbox_command_succeeds(self):
    ...
    """
    adapter = SandboxAdapter('https://localhost', 'ACCESS-TOKEN')
    print_var_type_n_val(var001 = adapter, pointer = "#23456UHGDCVRFgfff")#23456UHGDCVRFgfff_
