...
class KeyGeneratorTestCase(TestCase):
  ...
  def test_get_keys_single(self):
    ...
    with warnings.catch_warnings(record=True) as catched_warnings:
      ...
      print_var_type_n_val(var001 = kg, pointer = "#YTRFGDFGHDFGHFDGH")#YTRFGDFGHDFGHFDGH
# Value: 
# # <iota.crypto.signing.KeyGenerator object at 0x0000027DB9458E48>

# Type: <class 'iota.crypto.signing.KeyGenerator'>
      # print("kg: ", kg)
      # print('type(kg): ', type(kg))
      # for s in map(str, str(kg).split('\n')):
      #   print (s)
  ...
  def test_get_keys_long_seed(self):
    ...
    with warnings.catch_warnings(record=True) as catched_warnings:
      ...
      # print('SeedWarning001: ', SeedWarning)
      # # <class 'iota.crypto.SeedWarning'>
      ...
      print_var_type_n_val(var001 = kg, pointer = "#UYTRGHBghjhgfrty")#UYTRGHBghjhgfrty
# Value: 
# # <iota.crypto.signing.KeyGenerator object at 0x0000026668D7E2E8>
...
# Type: <class 'iota.crypto.signing.KeyGenerator'>
  ...
  def test_get_keys_multiple(self):
    ...
    print_var_type_n_val(var001 = kg, pointer = "#DFGHBnbvc87654RT")#DFGHBnbvc87654RT
# Value: 
# # <iota.crypto.signing.KeyGenerator object at 0x0000026668D7E2E8>
...
# Type: <class 'iota.crypto.signing.KeyGenerator'>
  ...
  def test_get_keys_error_count_too_small(self):
    ...
    # print('kg.get_keys(start=42, count=0): ', kg.get_keys(start=42, count=0))
    # print('type(kg.get_keys(start=42, count=0)): ', type(kg.get_keys(start=42, count=0)))
    # print_var_type_n_val(var001 = kg.get_keys(start=42, count=0)
    #   , pointer = "#234567654fgdfddfETERT")#234567654fgdfddfETERT_
    # # Line above is going to generate error... Looks like, the var001 is going to have value when there is some kind of Error
  ...
  def test_get_keys_error_step_zero(self):
    ...
    # print_var_type_n_val(var001 = kg.get_keys(start=42, step=0), pointer = "#3456TREDFGHBvbnhytrtyuiiu")#3456TREDFGHBvbnhytrtyuiiu_
  ...
  def test_get_keys_step_negative(self):
    ...
    print_var_type_n_val(var001 = kg.get_keys(start=1, count=2, step=-1), pointer = "#SDFGbvXCVGEDFTYHGDV654sdftr")#SDFGbvXCVGEDFTYHGDV654sdftr
# Value: 
# # [PrivateKey(b''), PrivateKey(b'')]
...
# Type: <class 'list'>
  ...
  def test_iterations(self):
    ...
    print_var_type_n_val(var001 = kg, pointer = "#XCGGDhrty654")#XCGGDhrty654
# Value: 
# # <iota.crypto.signing.KeyGenerator object at 0x00000195D04B8EB8>

# Type: <class 'iota.crypto.signing.KeyGenerator'>
    print_var_type_n_val(var001 = kg.get_keys(start=1, iterations=2), pointer = "#AZERBVSDFhgfdfgYT654")#AZERBVSDFhgfdfgYT654
# Value: [PrivateKey(b'')]
# Type: <class 'list'>
    self.assertListEqual(
  ...
  def test_generator(self):
    ...
    print('kg00: ', kg)
    # # <iota.crypto.signing.KeyGenerator object at 0x0000012593690CF8>

    iterator = kg.create_iterator()
    # print('iterator001: ', iterator)
    # # <iota.crypto.signing.KeyIterator object at 0x000002401FA945F8>
    # a = next(iterator)
    # print('a001: ', a)
    # # 
    # print('next(iterator): ', next(iterator))
    # # 
    self.assertEqual(
      next(iterator),
